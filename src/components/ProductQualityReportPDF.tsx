...
interface ProductQualityReportPDFProps {
  evaluation: {
    store_name: string;
    store_city: string;
    pic: string;
...
const ProductQualityReportPDF = ({ evaluation, questions }: ProductQualityReportPDFProps) => {
...
export default ProductQualityReportPDF;
