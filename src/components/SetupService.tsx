...
const SetupService = () => {
  ...
  const [localQuestions, setLocalQuestions] = useState<ServiceQuestion[]>([]);
  ...
  const saveQuestionsMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['service-questions'] });
  ...
  const updateQuestion = (id: number, field: keyof ServiceQuestion, value: string | number) => {
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        <div>
          <h2 className="text-2xl font-semibold mb-2">Setup Service Form</h2>
